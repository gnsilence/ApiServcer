...
namespace ApiServcer.IocContainer
{
    /// <summary>
    /// 使用autofac
    /// </summary>
    public class AutofacContainer
    {
        ...
        /// 注册程序集。
        /// </summary>
        /// <param name="implementationAssemblyName">实现所在程序集名称</param>
        /// <param name="interfaceAssemblyName">接口所在程序集名称</param>
        ...
        public static async void SetCodeFirstAsync(string AssemblyName)
        {
            if (ConfigSettings.Instance.UseAutoSyncStructure)
            {
              await  SetCodeFirstForAll.SetCodeFirstAsync(AssemblyName);
            }
        }
    }
}
