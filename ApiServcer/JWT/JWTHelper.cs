...
namespace ApiServcer.JWT
{
    public class JWTHelper
    {
        ...
        //2qyg4coej88uqrono0xdmx4y0il5dn5y7b72tlb3imba677ht1p1xlfcnh36mk5u3xzjktfara29axvzk85apfplun7oslbe1m20c148p5d519kja5wvg7lmn5v4a5ou
        public JWTHelper(string issuer, string audience, string key = "2qktfara29axvzk85apfplun7oslbe1m20c148p5d519kja5wvg7lmn5v4a5ou")
        {
            mIssuer = issuer;
            mAudience = audience;
        ...
        public string CreateToken(string name, string role)
        {
            ...
            var item = mJwtSecurityTokenHandler.CreateEncodedJwt(mIssuer, mAudience, claimsIdentity, DateTime.Now.AddMinutes(-5),
                DateTime.Now.AddMinutes(Expires), DateTime.Now,
               mSigningCredentials);
            return item;
        }
        ...
        public ClaimsPrincipal ValidateToken(string token)
        {
            ...
            catch (Exception e)
            {
                ...
                {
                    throw new Exception("Token 格式非法");
                }
